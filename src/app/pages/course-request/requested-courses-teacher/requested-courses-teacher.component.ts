...
@Component({
  ...
  templateUrl: './requested-courses-teacher.component.html',
  styleUrl: './requested-courses-teacher.component.scss'
})
export class RequestedCoursesTeacherComponent  implements OnInit {
  teacherCourses: any[] = [];
